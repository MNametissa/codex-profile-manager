...
echo "Note: this installer cannot modify your current shell session."
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Reload your current shell:"
echo "     source $SHELL_RC"
echo "  2. Confirm the wrapper is active:"
echo "     type codex"
echo "     type codex-accounts"
echo "     type codexpm"
echo "  3. First checks:"
echo "     codex-accounts list"
echo "     codexpm docs getting-started"
echo ""
echo "Validation for a reloaded shell:"
bash -lc "source \"$SHELL_RC\" >/dev/null 2>&1 && type codex >/dev/null 2>&1 && type codex-accounts >/dev/null 2>&1 && printf '  wrapper check: ok\\n'" || true
